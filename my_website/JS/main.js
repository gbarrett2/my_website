...
//this calls initializer, basically starts the whole code
$(document).ready(initialize);

//by making the response a variable when you call it outside of the brackets
// it becomes undefined, instead of not defined
var response;
//response can't be accessed outside of the function
console.log(response);
